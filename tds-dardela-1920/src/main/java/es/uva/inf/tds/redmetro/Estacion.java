...
/**
 * Clase que representa una estación en una línea de metro. Cada estación tiene
 * asociada varias coordenadas GPS correspondientes a las entradas y salidas al
 * exterior de la estación. Tienen la particularidad de estar todas en un radio
 * máximo de 300m.
 */
